...
{width=60%}
![](images/approve_version.png) 

T> When adjusting page version, take note of the 'Page is Pending Approval' notice - unapproved newer page versions will be shown while you are editing the site and will ask to be approved. 
T> Through the Versions panel you can also delete versions if they are no longer required.